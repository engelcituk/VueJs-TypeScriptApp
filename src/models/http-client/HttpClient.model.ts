...
* @description
* Envuelve la funcionalidad de cliente HTTP para eivitar usar un paquete de terceros como Axios directamente
* y así simplificar su sustitución en el futuro si dicho paquete deja de ser mantenido o por cualquer otro motivo
*/
...
export class HttpClientModel implements HttpClientInterface {
    ...
    constructor() {
        // OPCIONAL por ahora: Añadir un interceptor de peticiones para manejar desde un único lugar errores u otras cosas para cada petición
    }
